...
export const SectionComponentNode = () => {
  return (
    <div className="flex flex-col w-[261px] h-[177px] items-center justify-center gap-[7.47px] p-[14.94px] absolute top-[1511px] left-[65px] bg-white rounded-xl shadow-[0px_2.13px_21.34px_#0000000d] aspect-[1.47]">
      <div className="inline-flex flex-col items-center gap-[14.94px] relative flex-[0_0_auto]">
        <img
          className="relative w-[43.74px] h-[43.21px]"
          alt="Asset"
          src="https://c.animaapp.com/z9aFHItQ/img/asset-231-1@2x.png"
        />
